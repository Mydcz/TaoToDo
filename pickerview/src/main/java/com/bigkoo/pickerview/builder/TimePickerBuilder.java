...
public class TimePickerBuilder {
    ...
    //Required
    public TimePickerBuilder(Context context, AppType type,OnTimeSelectListener listener) {
        this.type = type;
    ...
    public TimePickerBuilder isFutureData(boolean futureData) {
        mPickerOptions.futureData = futureData;
        return this;
    }
    ...
    public TimePickerView build() {
        return new TimePickerView(mPickerOptions,type);
    }
}
