...
import com.bigkoo.pickerview.listener.OnKyeClickListener;
...
public class BasePickerView {
    ...
    private View.OnKeyListener onKeyBackListener = new View.OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (clickListener!=null){
                ...
                clickListener.onClick(keyCode,event);
            }
    ...
    private OnKyeClickListener clickListener;
    public void  setOnKyeClickListener(OnKyeClickListener clickListener){
