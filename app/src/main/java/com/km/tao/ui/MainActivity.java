...
import com.km.tao.R;
import com.km.tao.adapter.TaskAdapter;
...
public class MainActivity extends BaseActivity<ActivityMainBinding> {
    ...
    protected void initView() {
        ...
        adapter = new TaskAdapter(this, mTask);
        ...
        //设置任务完成状态
        adapter.setFinishTaskListener((taskBean, position) -> {
            mTaskViewModel.updateTaskType(!taskBean.isCompleted(), taskBean.getId());
            mTaskViewModel.findAll();
        });
